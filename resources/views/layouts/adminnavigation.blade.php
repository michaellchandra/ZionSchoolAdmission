    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center flex-shrink-0 text-white mr-3 ml-6">
                    <span class="font-semibold text-xl tracking-tight">ADMIN PANEL</span>
                </div>

                <!-- Navigation Links -->
                {{-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('adminLayout')" :active="request()->routeIs('adminLayout')">
                        {{ __('adminLayout') }}
                    </x-nav-link>
                </div> --}}
                {{-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
